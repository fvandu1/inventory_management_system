...
public class AddProductController {
            ...
            if (product.getId() != 0) {
                ...
                if (product.getInv() - product2.getInv() > 0) {
                    ...
                    for (Part p : product2.getParts()) {
                        ...
                        if (p.getInv() - (product.getInv() - product2.getInv()) < p.getMinInv()) {
                            ...
                            for (Part p2 : partService.findAll()) {
                                ...
                                if (!product2.getParts().contains(p2)) {
                                    availParts.add(p2);
                                }
    ...
    @GetMapping("/buy")
    public String buy(@RequestParam("productID") int theId, Model theMode, RedirectAttributes attributes) {
